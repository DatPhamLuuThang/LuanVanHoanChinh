...
public class ScheduleTimeMngt : Controller
{
    #region Declare
    ...
    public ScheduleTimeMngt(IMenuServices menuView, INotyfService notyfService,
        ICoreServices<ScheduleTime> scheduletiemServices)
    {
        /* View Services */
        _menuView = menuView;
        ...
        /* Data Services */
        _scheduletimeServices = scheduletiemServices;
    }
    ...
    {
        var data = await _scheduletimeServices
            .GetAll()
            .ToListAsync();
    ...
    public IActionResult Edit(string id)
    {
        ...
        {
            var data = _scheduletimeServices.GetById(id);
    ...
    public async Task<IActionResult> Duplicate(string id)
    {
        ...
        {
            data.Id = new Guid();
            Helper.NotyfAssist(await _scheduletimeServices.AddAsync(data, userId), _notyfService);
        }
        else
        {
            _notyfService.Warning(Helper.NotyfMsg.Warning);
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Create(ScheduleTime data)
    {
        var userId = Guid.NewGuid();
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(string id, ScheduleTime data)
    {
        var userId = Guid.NewGuid();
        ...
        {
            ValidData(data);
            Helper.NotyfAssist(await _scheduletimeServices.UpdateAsync(data, userId), _notyfService);
        }
        else
        {
            _notyfService.Warning(Helper.NotyfMsg.Warning);
    ...
    public async Task<IActionResult> SoftDelete(string id)
    {
        ...
        if (data != null)
        {
            Helper.NotyfAssist(await _scheduletimeServices.SoftDeleteAsync(data, userId), _notyfService);
        }
        else
        {
            _notyfService.Warning(Helper.NotyfMsg.Warning);
    ...
    public async Task<IActionResult> HardDelete(string id)
    {
        ...
        if (data != null)
        {
            Helper.NotyfAssist(await _scheduletimeServices.HardDeleteAsync(data, userId), _notyfService);
        }
        else
        {
            _notyfService.Warning(Helper.NotyfMsg.Warning);
    ...
    private static void ValidData(ScheduleTime data) //Valid data before CRUD, call before CRUD
    {

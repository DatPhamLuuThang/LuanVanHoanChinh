    ...
    internal partial class StudentEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "CoreEntities.SchoolMgntModel.Student",
                typeof(Student),
                baseEntityType);
            ...
            var classRoomId = runtimeEntityType.AddProperty(
                "ClassRoomId",
                typeof(Guid?),
                propertyInfo: typeof(Student).GetProperty("ClassRoomId", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Student).GetField("<ClassRoomId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            ...
            var kindofConduct = runtimeEntityType.AddProperty(
                "KindofConduct",
                typeof(string),
                propertyInfo: typeof(Student).GetProperty("KindofConduct", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Student).GetField("<KindofConduct>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            kindofConduct.AddAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.None);
            ...
            var parentId = runtimeEntityType.AddProperty(
                "ParentId",
                typeof(Guid?),
                propertyInfo: typeof(Student).GetProperty("ParentId", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Student).GetField("<ParentId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            ...
            var rank = runtimeEntityType.AddProperty(
                "Rank",
                typeof(string),
                propertyInfo: typeof(Student).GetProperty("Rank", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Student).GetField("<Rank>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var classRoom = declaringEntityType.AddNavigation("ClassRoom",
                ...
                onDependent: true,
                typeof(ClassRoom),
                propertyInfo: typeof(Student).GetProperty("ClassRoom", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Student).GetField("<ClassRoom>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

            var students = principalEntityType.AddNavigation("Students",
                runtimeForeignKey,
                onDependent: false,
                typeof(ICollection<Student>),
                propertyInfo: typeof(ClassRoom).GetProperty("Students", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(ClassRoom).GetField("<Students>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

            runtimeForeignKey.AddAnnotation("Relational:Name", "FK_Student_ClassRoom");
        ...
        public static RuntimeForeignKey CreateForeignKey2(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var parents = declaringEntityType.AddNavigation("Parents",
                runtimeForeignKey,
                onDependent: true,
                typeof(Parents),
                propertyInfo: typeof(Student).GetProperty("Parents", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Student).GetField("<Parents>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

            var students = principalEntityType.AddNavigation("Students",
                runtimeForeignKey,
                onDependent: false,
                typeof(ICollection<Student>),
                propertyInfo: typeof(Parents).GetProperty("Students", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Parents).GetField("<Students>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

            runtimeForeignKey.AddAnnotation("Relational:Name", "FK_Student_Parents");
            return runtimeForeignKey;
        }
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "Student");

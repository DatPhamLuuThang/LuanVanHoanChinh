...
{
    internal partial class NewsEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "CoreEntities.SchoolMgntModel.News",
                typeof(News),
                baseEntityType);
            ...
            var imgSchoolFileName = runtimeEntityType.AddProperty(
                "ImgSchoolFileName",
                typeof(string),
                propertyInfo: typeof(News).GetProperty("ImgSchoolFileName", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(News).GetField("<ImgSchoolFileName>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            imgSchoolFileName.AddAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.None);
            ...
            var newsSchool = runtimeEntityType.AddProperty(
                "NewsSchool",
                typeof(string),
                propertyInfo: typeof(News).GetProperty("NewsSchool", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(News).GetField("<NewsSchool>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            newsSchool.AddAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.None);

            var noty = runtimeEntityType.AddProperty(
                "Noty",
                typeof(string),
                propertyInfo: typeof(News).GetProperty("Noty", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(News).GetField("<Noty>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            noty.AddAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.None);
